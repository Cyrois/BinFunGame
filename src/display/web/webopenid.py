...
Notes:
 ...
 - This will create a file called .openid_secret_key in the 
   ...
   if the Display can't find this file for any reason (e.g. you 
   moved the Display somewhere else) then each currently logged 
 ...
 - State must be maintained through the entire auth process 
   ...
   serving one set of URLs or if you restart your Display often 
