...
class application:
    ...
    Application to delegate requests based on path.
        ...
        >>> urls = ("/hello", "hello")
        >>> Display = application(urls, globals())
        >>> class hello:
        ...     def GET(self): return "hello"
        >>>
        >>> Display.request("/hello").data
        'hello'
    """
    ...
    def add_processor(self, processor):
        ...
        Adds a processor to the application. 
            ...
            ...
            >>> Display.add_processor(hello)
            >>> Display.request("/web.py").data
            'hello, web.py'
        """
    ...
    def request(self, localpart='/', method='GET', data=None,
        ...
        Response will be a storage object with data, status and headers.
            ...
            ...         return "hello"
            ...
            >>> response = Display.request("/hello")
            >>> response.data
            'hello'
            >>> response.status
            '200 OK'
        ...
        To use https, use https=True.
            ...
            ...
            >>> response = Display.request("/redirect")
            >>> response.headers['Location']
            'http://0.0.0.0:8080/foo'
            >>> response = Display.request("/redirect", https=True)
            >>> response.headers['Location']
    ...
    def _delegate_sub_application(self, dir, app):
        """Deletes request to sub application `Display` rooted at the directory `dir`.
...
class auto_application(application):
    ...
    automatiacally using metaclass.
        ...
        >>> Display = auto_application()
        >>> class hello(Display.page):
        ...     def GET(self): return "hello, world"
        ...
        >>> class foo(Display.page):
        ...     path = '/foo/.*'
        ...     def GET(self): return "foo"
        >>> Display.request("/hello").data
        'hello, world'
        >>> Display.request('/foo/bar').data
        'foo'
    """
    def __init__(self):
...
class subdomain_application(application):
    ...
    Application to delegate requests based on the host.
        ...
        ...     def GET(self): return "hello"
        >>>
        >>> mapping = (r"hello\.example\.com", Display)
...
def loadhook(h):
    ...
    Converts a load hook into an application processor.
        ...
        ...
        >>> Display.add_processor(loadhook(f))
    """
...
def unloadhook(h):
    ...
    Converts an unload hook into an application processor.
        ...
        ...
        >>> Display.add_processor(unloadhook(f))    
    """
    def processor(handler):
        try:
            result = handler()
